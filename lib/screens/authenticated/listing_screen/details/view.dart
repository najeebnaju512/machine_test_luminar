                  ...
                  children: [
                    sectionCard(
                      ...
                      children: [
                        ...
                        detailRow(
                          label: "Whatsapp",
                          value: lead.whatsappNumber?.toString(),
                          icon: Icons.message,
                        ),
                        detailRow(
                          label: "Email",
                    ...
                    sectionCard(
                      ...
                      children: [
                        ...
                        detailRow(
                          label: "Parent Phone",
                          value: lead.parentPhoneNumber?.toString(),
                          icon: Icons.call,
                        ),
                      ],
                    ),
                    sectionCard(
                      ...
                      children: [
                        ...
                        detailRow(
                          label: "Qualification",
                          value: lead.qualificationDetails?.toString(),
                        ),
                        detailRow(
                          label: "Pass Out Year",
                          value: lead.passOutYear?.toString(),
                        ),
                        detailRow(
                          label: "Preferred Location",
                          value: lead.preferredLocationDetails?.toString(),
                        ),
                        detailRow(
                          label: "Course",
                          value: lead.courseDetails?.toString(),
                        ),
                        detailRow(
                          label: "Course Mode",
                          value: lead.courseModeDetails?.toString(),
                        ),
                      ],
                    ),
                    sectionCard(
                      ...
                      children: [
                        detailRow(
                          label: "Lead Status",
                          value: lead.leadStatusDetails?.name,
                        ),
                        detailRow(
                          label: "Lead Source",
                          value: lead.leadSourceDetails?.label,
                        ),
                        detailRow(
                          label: "Facebook Campaign",
                          value: lead.facebookCampaign,
                        ),
                        detailRow(
                          label: "Facebook Form",
                          value: lead.usedFacebookFormDetails?.name,
                        ),
                        detailRow(
                          label: "Is Active",
                          value: lead.isActive == true ? "Yes" : "No",
                        ),
                        detailRow(
                          label: "Is Archived",
                          value: lead.isArchived == true ? "Yes" : "No",
                        ),
                        detailRow(
                          label: "Is Resubmission",
                          value: lead.isResubmission == true ? "Yes" : "No",
                        ),
                      ],
                    ),
                    sectionCard(
                      ...
                      children: [
                        detailRow(
                          ...
                          value: lead.followupCount?.toString(),
                        ),
                        detailRow(
                          label: "Completed",
                          value: lead.completedFollowups?.toString(),
                        ),
                        detailRow(
                          label: "Pending",
                          value: lead.pendingFollowups?.toString(),
                        ),
                        detailRow(
                          label: "Next Follow-up",
                          value: lead.nextFollowup?.toString(),
                        ),
                        detailRow(
                          label: "Last Follow-up",
                          value: lead.lastFollowup?.toString(),
                        ),
                        detailRow(
                          label: "Reminder Date",
                          value: lead.reminderDate?.toString(),
                        ),
                      ],
                    ),
                    sectionCard(
                      ...
                      children: [
                        ...
                        detailRow(
                          label: "Is Editable",
                          value: lead.isEditable == true ? "Yes" : "No",
                        ),
                        detailRow(
                          label: "Is Deletable",
                          value: lead.isDeletable == true ? "Yes" : "No",
                        ),
                      ],
                    ),
                    sectionCard(
                      ...
                      children: [
                        detailRow(
                          label: "Name",
                          value: lead.counselorDetails?.fullName,
                        ),
                        detailRow(
                          label: "Email",
                          value: lead.counselorDetails?.email,
                        ),
                        detailRow(
                          label: "Phone",
                          value: lead.counselorDetails?.phone,
                        ),
                        detailRow(
                          label: "Role",
                          value: lead.counselorDetails?.roleDetails?.label,
                        ),
                        detailRow(
                          label: "Is Staff",
                          value: lead.counselorDetails?.isStaff == true
                              ? "Yes"
                              : "No",
                        ),
                        detailRow(
                          label: "Is Superuser",
                          value: lead.counselorDetails?.isSuperuser == true
                              ? "Yes"
                              : "No",
                        ),
                      ],
